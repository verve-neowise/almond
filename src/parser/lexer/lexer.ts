import { LexerError } from "../errors/index"
...
export default class Lexer {
    ...
    private includeWhitespaces: boolean

    constructor(source: Source, includeWhitespaces: boolean = false) {
        this.source = source
    ...
    tokenizeWhitespace() {
        ...
        this.addToken(this.buffer.join(''), TokenType.WHITESPACE)
    }
    ...
    tokenizeComment() {
        ...
        this.addToken(this.buffer.join(''), TokenType.COMMENT)
    }
    ...
    addToken(text: string, type: TokenType) {
        this.source.confirm()
        this.tokens.push(new Token(text, type, this.source.confirmedRow, this.source.confirmedColumn))
    }
}
